...
tipo_de_cambio_eur_a_mex = 23.7 # en un caso real se toma el dato de una base de datos 
tipo_de_cambio_usd_a_mex = 20.75

# 1. Solicitar el tipo de moneda y convertir a mayúsculas 
tipo_de_moneda = input("Por favor, ingresá la moneda que querés convertir (EURO / USD): ").upper()
